...
<form method="post" name="sneakersforms" id="sneakersforms" >
        ...
        <table border='0'>
            ...
            <tr>
                <td><input name="Submit" type="button" value="Enviar" onclick="validateSneakers();"><td>
                <td align="right"><button><a href="index.php?page=controller_sneakers&op=list_sneakers">Volver</a></button></td>
            </tr>
        </table>
    </form>
</div>